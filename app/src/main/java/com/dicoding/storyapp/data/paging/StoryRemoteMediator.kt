...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = getStoriesFromApi(page, state.config.pageSize)
                ?: return MediatorResult.Error(Exception("Connection Error"))
    ...
    private suspend fun getStoriesFromApi(page: Int, pageSize: Int): StoryResponse? {
        val response = apiService.getStories(userToken, page, pageSize)
